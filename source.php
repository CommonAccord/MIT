...
echo "
<a href=$_SERVER[PHP_SELF]?action=list&file=$rootdir[dirname]/>MIT:$rootdir[dirname]</a>/<b>$filenameX</b>
&emsp; &emsp; &emsp; &emsp;
<a href=$_SERVER[PHP_SELF]?action=print&file=$rootdir[dirname]/$filenameX>Print</a>
  &emsp;  &emsp;  &emsp;  
<a href=https://github.com/CommonAccord/MIT/blob/master/Doc/$rootdir[dirname]/$filenameX>GitHub</a>
